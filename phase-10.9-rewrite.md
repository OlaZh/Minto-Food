...
- [ ] зміни в shell вносяться один раз у shared source, а не вручну по всіх HTML — потребує template/include системи
...
- [ ] одна візуальна мова
- [ ] нуль відчуття "кожна сторінка живе за своїми правилами"
