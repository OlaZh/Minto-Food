...
> **Уточнення 14.09.2026:** розрахунок КБЖВ рецептів тимчасово вимкнено локально на прохання власниці; ручне й автоматичне розпізнавання не запускаються. Повторне ввімкнення — після доопрацювання. Окремі вкладення для інгредієнтів/приготування та відео файлами/посиланнями запитані, але ще не реалізовані. [Стан, межі перевірки й пропозиція сховища](recipe-media-plan.md). Чинна серверна перевірка фото все ще охоплює приватні рецепти — правило NO auto-flagging нижче не повністю відповідає коду.
