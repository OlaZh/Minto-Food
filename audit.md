...
- 🟨 **Профіль (profile.html)** — ІТЕРАЦІЯ 4, частина А (2026-06-16): **вкладка «Налаштування» + перемикач ЗРОБЛЕНІ.**
  ...
  - **📋 Прев'ю наступних сторінок (вже мають часткову data-i18n розмітку БЕЗ ключів — показуються UA):** week-menu (`createRecipeBtn`), recipes (`recipesTitle/addRecipe/searchPlaceholder/...` 14 ключів). shopping-list (21) і cookbook (21) — наявні data-i18n усі мають ключі (але є й нерозмічений UA-текст).
